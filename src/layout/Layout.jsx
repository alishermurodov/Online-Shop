  ...
  return (
    <div>
      ...
      <div className='navbar m-auto overflow-x-hidden'>
        ...
        <div className='m-auto w-[85%] flex justify-between items-center'>
          <div>
          ...
          <ul className='hidden xl:flex xl:gap-[48px] xl:text-[16px] xl:leading-[24px] text-black'>
            <Link to="/">
              <li style={{ textDecoration: pathname == "/" ? "underline" : "none" }} className='cursor-pointer' data-aos="fade-down" data-aos-duration="1250">Home</li>
            </Link>
            <Link to="contact">
              <li style={{ textDecoration: pathname == "/contact" ? "underline" : "none" }} className='cursor-pointer' data-aos="fade-down" data-aos-duration="1250">Contact</li>
            </Link>
            <Link to="about">
              <li style={{ textDecoration: pathname == "/about" ? "underline" : "none" }} className='cursor-pointer' data-aos="fade-down" data-aos-duration="1250">About</li>
            </Link>
            <Link to="signup">
          ...
          <div className='flex items-center gap-[1px] lg:gap-[24px]'>
            <input type="search" name="" id="" placeholder='What are you looking for?' className='hidden lg:block w-[243px] h-[38px] rounded-[4px] bg-[#F5F5F5] text-[#7A7A7A] text-[12px] font-medium py-[7px] pl-[20px] pr-[12px] outline-none' data-aos="fade-left" data-aos-duration="1250" />
            <div className='flex items-center gap-[5px] lg:gap-[16px]'>
              <Link to="wishlist">
        ...
        <div className='bg-black m-auto'>
          ...
          <div className='m-auto w-[85%] flex flex-col items-center gap-[48px] sm:flex-row sm:gap-0  sm:justify-between'>
            ...
            <div className='flex flex-col gap-[24px]'>
              ...
              <h4 className='text-white text-[20px] font-medium leading-[28px]'>Subscribe</h4>
              <div className='flex flex-col gap-[16px]'>
                <p className='text-white text-[16px] leading-[24px] font-light'>Get 10% off your first order</p>
                <input type="text" name="" id="" placeholder='Enter your email' className='w-[217px] h-[48px] rounded-[4px] bg-inherit text-[#7A7A7A] text-[12px] font-medium py-[12px] pl-[16px] border-[1.5px] border-white outline-none' />
              </div>
            </div>
            ...
            <div className='hidden xl:flex flex-col gap-[24px]'  >
              ...
              <div className='flex flex-col gap-[16px]'>
                ...
                <p className='text-white text-[16px] leading-[24px] font-light'>exclusive@gmail.com</p>
                <p className='text-white text-[16px] leading-[24px] font-light'>+88015-88888-9999</p>
              </div>
            </div>
            ...
            <div className='flex flex-col items-start gap-[24px]'>
              <h4 className='text-white text-[20px] font-medium leading-[28px]'>Download App</h4>
              <div className='flex flex-col gap-[8px]'>
                <p className='text-[#AFAFAF] text-[12px] font-medium leading-[18px]'>Save $3 with App New User Only</p>
