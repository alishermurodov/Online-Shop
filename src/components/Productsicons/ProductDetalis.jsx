    ...
    <div className="dark:text-[white] py-[50px]">
      <div className="w-[80%] m-auto">
        ...
        <div className="w-[100%] flex flex-wrap justify-center items-center gap-[5%] py-[40px]">
          <div className="xl:w-[55%] w-[80%] flex gap-[13%] items-center">
            <div className="w-[24%] xs:hidden sm:block">
             {Object.keys(productShow)?.length === 0 &&
              <img
                className="py-[20px]"
                src={"http://localhost:3000/" + productShow?.media[0]?.src}
                alt=""
              />
}
              <img
              ...
              <img
                className="pb-[20px]"
                src={"http://localhost:3000/" + productShow?.media[1]?.src}
                alt=""
              />
              <img
                className="pb-[20px]"
                src={"http://localhost:3000/" + productShow?.media[2]?.src}
                alt=""
              />
              <img
                className="pb-[20px]"
                src={"http://localhost:3000/" + productShow?.media[3]?.src}
                alt=""
              />
            </div>
            <div className="w-[72%]">
              <img className='w-[70%]' src={"http://localhost:3000/" + productShow?.media[1]?.src}
                alt="" />
            </div>
          </div>
