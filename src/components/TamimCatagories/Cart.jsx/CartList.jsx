...
const CartList = () => {
  ...
  {` ${(0.6 * Number(product.price.replace('$', ''))).toFixed(2)}`}
    ...
    <div className='flex gap-[20px] mt-[100px] ml-[310px] max:flex-wrap max3:ml-[0] max3:justify-center'>
    ...
    <div className='flex justify-end pr-[340px] mt-[-100px] max2:justify-center max:m-[0] max2:pl-[20px] max2:mt-[100px] dark:text-white '>
