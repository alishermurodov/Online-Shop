    ...
    <div>
      ...
      <div className='dark:text-[#fff]'>
        <div className="w-[90%] md:w-[85%] mx-auto py-[40px]">
          ...
          <div className="md:flex justify-between items-end mb-[40px]">
            <div className="flex items-end md:w-[50%] justify-between">
              <div className="">
                ...
                <h2 className='text-[32px] md:text-[48px] font-[600]'>Flash Sales</h2>
              </div>
              <div className="flex gap-[16px]">
                <div className="">
                  <p className='font-[600] text-[12px]'>Days</p>
                  <h2 className='font-[600] text-[32px]'>{new Date().getDate()}</h2>
                </div>
                <div className="">
                  <p className='font-[600] text-[12px]'>Hours</p>
                  <h2 className='font-[600] text-[32px]'>{new Date().getHours()}</h2>
                </div>
                <div className="">
                  <p className='font-[600] text-[12px]'>Minutes</p>
                  <h2 className='font-[600] text-[32px]'>{new Date().getMinutes()}</h2>
                </div>
                <div className="">
                  <p className='font-[600] text-[12px]'>Seconds</p>
                  <h2 className='font-[600] text-[32px]'>{new Date().getSeconds()}</h2>
                </div>
              </div>
            </div>
            ...
            <div className="md:flex justify-between items-end mb-[60px]">
              <div className="flex items-end md:w-[50%] justify-between">
                <div className="">
                  ...
                  <h2 className='text-[32px] md:text-[48px] font-[600]'>Browse By Category</h2>
                </div>
              </div>
              <div className="flex items-center gap-[8px]">
                <img src={toLeft} alt="" />
            ...
            <div className="md:flex justify-between items-end mb-[60px]">
              <div className="flex items-end md:w-[50%] justify-between">
                <div className="">
                  ...
                  <h2 className='text-[32px] md:text-[48px] font-[600]'>Best Selling Products</h2>
                </div>
              </div>
              <div className="flex items-center gap-[8px]">
          ...
          <div className="py-[30px] md:py-[70px] bg-black font-[600] px-[56px] lg:flex justify-between my-[40px]">
            <div className="">
              ...
              <div className="flex gap-[16px] mb-[40px]">
                ...
                <div className="rounded-[50%] bg-[#fff] p-[15px] w-[62px] h-[62px]">
                  <h2 className='font-[800] text-[11px] text-center'>{new Date().getHours()}</h2>
                  <p className='font-[600] text-[11px] text-center'>Hours</p>
                </div>
                <div className="rounded-[50%] bg-[#fff] p-[15px] w-[62px] h-[62px]">
                  <h2 className='font-[800] text-[11px] text-center'>{new Date().getMinutes()}</h2>
                  <p className='font-[600] text-[11px] text-center'>Minutes</p>
                </div>
                <div className="rounded-[50%] bg-[#fff] p-[15px] w-[62px] h-[62px]">
                  <h2 className='font-[800] text-[11px] text-center'>{new Date().getSeconds()}</h2>
            ...
            <img className='lg:w-[50%]' src={speakerBig} alt="" />
          </div>
          <div className="md:flex justify-between items-end mb-[60px]">
            <div className="flex items-end md:w-[50%] justify-between">
              <div className="">
                ...
                <h2 className='text-[32px] md:text-[48px] font-[600]'>Explore Our Products</h2>
              </div>
            </div>
            <div className="flex items-center gap-[8px]">
              <img src={toLeft} alt="" />
          ...
          <div className="">
            <div className="">
              ...
              <h2 className='text-[32px] md:text-[48px] font-[600]'>New Arrival</h2>
            </div>
          </div>
          <div className="">
            {/* <Safi /> */}
